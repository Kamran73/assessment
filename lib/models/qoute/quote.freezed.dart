...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Quote&&(identical(other.q, q) || other.q == q)&&(identical(other.a, a) || other.a == a));
}
...
/// Create a copy of Quote
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? q = null,Object? a = freezed,}) {
...
class _Quote implements Quote {
  const _Quote({required this.q, this.a});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Quote&&(identical(other.q, q) || other.q == q)&&(identical(other.a, a) || other.a == a));
}
...
/// Create a copy of Quote
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? q = null,Object? a = freezed,}) {
  return _then(_Quote(
q: null == q ? _self.q : q // ignore: cast_nullable_to_non_nullable
as String,a: freezed == a ? _self.a : a // ignore: cast_nullable_to_non_nullable
as String?,
